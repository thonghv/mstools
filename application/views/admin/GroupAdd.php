...
<div class="row-fluid">
    ...
    <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>group/submitAddDetail?id=<?php echo $groupId; ?>" name="inbox">
        <div class="tabbable">
                    ...
                    if($group != null){
                      ...
                      $row=(object)$row;
                       ...
                       <td colspan="2"><label for="title"></label>
                            <input type="hidden" id="group" name="group" value="<?php echo $groupId; ?>" class="form-control" style ="width: 500px"/>
                        </td>   
            ...
            <tr>
                <td>
                   <label class="col-sm-3 control-label no-padding-right" for="form-field-oldpass"><strong>Category</strong></label>
                </td>
                <td colspan="2"><label for="title"></label>
            ...
            <div class="col-md-offset-3 col-md-9 no-marginleft">
                <button class="btn btn-info" type="submit">
                    <i class="icon-ok bigger-110"></i>
                                                Save Change    </button>
                                            &nbsp; &nbsp;
               <a href="<?php echo base_url();?>group/detail?id=<?php echo $groupId; ?>">
