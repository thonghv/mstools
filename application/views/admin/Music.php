...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Gói Sản Phẩm - Quản Lý Hệ Thống</title>
                    ...
                    <div id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <span class="divider"><i class="icon-angle-right"></i></span></li>
                             <li class="active"><a href="<?php echo base_url();?>category">Category</a>
                             <span class="divider"><i class="icon-angle-right"></i></span></li>
                            <li class="active">Song List</li>
                        </ul><!--.breadcrumb-->
...
<div class="row-fluid">
    ...
    <?php }?>
    <a href="<?php echo base_url();?>category/add?id=<?php echo $categoryId; ?>">
    ...
    <table id="table_report" class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th style ="width: 70px;" class="hidden-phone">Views</th>
                    <th style ="width: 100px;" class="hidden-phone">Image</th>
                    <th style ="width: 100px;" class="hidden-phone">Stream</th>
                    <th></th>
                </tr>
            </thead>                   
            <tbody>
                ...
                <tr>
                    ...
                    <td class='hidden-phone'><?php echo  $row -> img_url ; ?></td>
                    <td class='hidden-phone'><?php echo  $row -> stream_url ; ?></td>
                    <td>
                     ...
                     <div class="modal fade" id="confirm-delete-<?php echo $row -> id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Bạn có chắc chắn muốn xóa bài hát này ra khỏi danh sách hay không ?</p>
                                            <p class="debug-url"></p>
                                        </div>
                                        
                                        <div class="modal-footer">
                                            <a  href="<?php echo base_url(); ?>category/removeSong?id=<?php echo $row->id; ?>&category=<?php echo $categoryId ?>" class="btn btn-danger btn-ok">Xóa</a>
                            ...
                            <a href="<?php echo base_url(); ?>category/update?id=<?php echo $row -> id;?>&category=<?php echo $categoryId; ?>">
                            <input class='btn btn-mini btn-info' type="button" name="editsp" value="Update"/>
                             </a>
