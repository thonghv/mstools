...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">UPDADTE CATEGORY
    </h3> 
    <?php
    if(!isset( $_SESSION )) 
    { 
    ...
    <?php }?>
     ...
     <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>category/submitChange" name="inbox">
        <div class="tabbable">
