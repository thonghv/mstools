            ...
            <div id="main-content" class="clearfix">
                    ...
                    <div id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Udpate Group</li>
                        </ul><!--.breadcrumb-->
...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">UPDADTE GROUP
    </h3> 
    <?php
    if(!isset( $_SESSION )) 
    { 
    ...
    <?php }?>
     ...
     <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>group/submitChange" name="inbox">
        <div class="tabbable">
