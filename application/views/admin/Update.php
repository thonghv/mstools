...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Update song  - Music Tools</title>
...
<div class="row-fluid">
    ...
    <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>category/updateSong" name="inbox">
        <div class="tabbable">
            <table align="left" cellpadding="7" cellspacing="10">
             ...
             <tr>
                <td colspan="2"><label for="title"></label>
                    <input type="hidden" id="id" name="id" value="<?php echo $id; ?>" class="form-control" style ="width: 500px"/>
            ...
            <tr>
                ...
                <td colspan="2"><label for="title"></label>
                   <input type="text" id="cost" name="author" value="<?php echo $row -> author; ?>" class="form-control" style ="width: 500px"/>
                </td>         
            </tr>
            <tr>
                <td>
                ...
                <td colspan="2"><label for="title"></label>
                   <input type="text" id="origin" name="image" value="<?php echo $row -> img_url; ?>" class="form-control" style ="width: 500px"/>
                </td>            
            </tr>
            <tr>
                <td>
                ...
                <td colspan="2"><label for="title"></label>
                   <input type="text" id="profit" name="stream" value="<?php echo $row -> stream_url; ?>" class="form-control" style ="width: 500px"/>
                </td>            
            </tr>
             <tr>
                <td>
                ...
                <td colspan="2"><label for="title"></label>
                   <input type="text" id="profit" name="like" value="<?php echo $row -> likes; ?>" class="form-control" style ="width: 500px"/>
                </td>            
            </tr>
             <tr>
                <td>
                ...
                <td colspan="2"><label for="title"></label>
                   <input type="text" id="profit" name="view" value="<?php echo $row -> views; ?>" class="form-control" style ="width: 500px"/>
                </td>            
            </tr>
             <?php endforeach; }?>      
            </table>
            ...
            <div class="col-md-offset-3 col-md-9 no-marginleft">
                <button class="btn btn-info" type="submit">
                    <i class="icon-ok bigger-110"></i>
                                            ...
                                            &nbsp; &nbsp;
               <a href="<?php echo base_url();?>category/detail?id=<?php echo $row -> category; ?>">
