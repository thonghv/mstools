...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Category - Music Tools</title>
...
<div class="row-fluid">
    ...
    <?php }?>
     ...
     <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>category/insert" name="myForm">
        <div class="tabbable">
            ...
            <tr>
                <td>
                   ...
                   </style><strong>Category Name&nbsp;</strong></label>
                </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <div class="modal fade" id="confirm-delete-<?php echo $row -> id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a  href="<?php echo base_url(); ?>category/remove/<?php echo $row->id; ?>" class="btn btn-danger btn-ok">Xóa</a>
                            ...
                            <a href="<?php echo base_url();?>category/detail?id=<?php echo  $row -> id ; ?>">
                            <input class='btn btn-mini btn-default' type="button" name="editsp" value="&nbsp;&nbsp;Detail&nbsp;&nbsp;"/>
                             </a>
                            <a href="<?php echo base_url();?>category/change/<?php echo $row -> id ; ?>">
