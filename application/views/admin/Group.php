...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">GROUPS
    </h3> 
    <?php
    if(!isset( $_SESSION )) 
    { 
    ...
    <?php }?>
     ...
     <form method='post' onsubmit="return checkform()"  class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>group/insert" name="myForm">
        <div class="tabbable">
            ...
            <tr>
                <td>
                   ...
                   </style><strong>Group Name&nbsp;</strong></label>
                </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <div class="modal fade" id="confirm-delete-<?php echo $row -> id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <a href="<?php echo base_url(); ?>group/detail?id=<?php echo  $row -> id ; ?>">
                            <input class='btn btn-mini btn-default' type="button" name="editsp" value="&nbsp;&nbsp;Detail&nbsp;&nbsp;"/>
                             </a>
                            <a href="<?php echo base_url(); ?>group/change/<?php echo  $row -> id ; ?>">
                            ...
                            <a href="<?php echo base_url(); ?>api/group/data?id=<?php echo  $row -> id ; ?>" target="_blank">
                            <input class='btn btn-mini btn-yellow' type="button" name="editsp" value="&nbsp;&nbsp;Data Json&nbsp;&nbsp;"/>
                             </a>
                            <br>  
